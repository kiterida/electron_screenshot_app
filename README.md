...
When switching projects, its a good idea to tell codex.

You are now working on a new Electron app project.

Stack:
- Electron
- Stand Alone Desktop App (not localhost)
- better-sqlite3 for database
- React
- Node.js

This is NOT related to my previous app.
