...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getVideoExportSequences: () => ipcRenderer.invoke('get-video-export-sequences'),
  getVideoExportSequenceById: (sequenceId) => ipcRenderer.invoke('get-video-export-sequence-by-id', sequenceId),
  saveVideoExportSequence: (payload) => ipcRenderer.invoke('save-video-export-sequence', payload),
  deleteVideoExportSequence: (sequenceId) => ipcRenderer.invoke('delete-video-export-sequence', sequenceId),
  ...
  createMediaSection: (mediaItemId) => ipcRenderer.invoke('create-media-section', mediaItemId),
